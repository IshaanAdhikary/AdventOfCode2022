...
public class Day4Part1 {
    public static Integer findContainedRanges() throws FileNotFoundException {
        ...
        while (in.hasNextLine()) {
            ...
            if (elfIDRanges[0] >= elfIDRanges[2] && elfIDRanges[1] <= elfIDRanges[3]) amount++;
            else if (elfIDRanges[0] <= elfIDRanges[2] && elfIDRanges[1] >= elfIDRanges[3]) amount++;
        }
