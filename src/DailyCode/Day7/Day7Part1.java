...
public class Day7Part1 {
    public static Integer sizeOfSmallFiles() throws FileNotFoundException {
        ...
        // Adds together every folder under 100,000 units of data
        int total = 0;
        for (FolderContents folder : allFolders.values()) {
            int dataSize = folder.getDataSize();
            total = total + (dataSize <= 100000 ? dataSize : 0);
        }
