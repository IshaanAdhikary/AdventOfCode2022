...
public class Day5Part1 {
    public static String findTopCrates() throws FileNotFoundException {
        ...
        while (in.hasNextLine()) {
            ...
            // Pops the top crate of the origin and pushes it to the target for the amount of times required.
            for (int i = 0; i < amount; i++) crateStacks.get(target).push(crateStacks.get(origin).pop());
        }
